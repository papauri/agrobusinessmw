<?php
$pageTitle = 'Privacy Policy — AgroBusiness Malawi';
$pageDesc  = 'How AgroBusiness Malawi collects, uses, protects and retains information.';
include __DIR__ . '/partials/head.php';
?>
<body>
    <a href="#main-content" class="skip-link">Skip to main content</a>
    <main id="main-content" class="main-content" style="min-height:100vh;padding:3rem 1rem">
        <div class="container" style="max-width:860px">
            ...
            <section style="background:#fff;border:1px solid var(--border);border-radius:16px;padding:clamp(1.25rem,4vw,2.25rem);box-shadow:var(--shadow-glow)">
                ...
                <p>Weather and reference market information may come from external data providers. AgroBusiness Malawi does not control those providers and may cache information to improve availability on slower connections.</p>
                <h2>6. Security</h2>
                <p>We use access controls, password hashing, CSRF protection, prepared database statements and audit records where appropriate. No internet service can guarantee absolute security, so please avoid submitting passwords or other secrets in ordinary forms.</p>
                <h2>7. Retention</h2>
                <p>We retain information for as long as reasonably necessary to provide the service, maintain auditability, resolve disputes, meet operational needs, or comply with applicable requirements. Retention periods may differ by data type.</p>
                <h2>8. Your choices</h2>
                <p>You may contact AgroBusiness Malawi to ask about information associated with your account or directory entry and to request correction where appropriate.</p>
                <h2>9. Changes to this policy</h2>
                <p>We may update this policy as the platform evolves. The date above will be updated when material changes are made.</p>
                <h2>10. Contact</h2>
                <p>For privacy questions or requests, contact the AgroBusiness Malawi project administrators through the support channel provided by the platform.</p>
            </section>
