 ...
 *
 *  1. config.js and phone-normalizer.js are plain scripts: they define globals
 *     (AGRO_CONFIG, AgroPhone) that later modules read on first use.
...
<script src="assets/js/app.js?v=20260816-0001" defer></script>
<script src="assets/js/directory-navigation.js?v=20260816-0001" defer></script>
...
<link rel="stylesheet" href="assets/css/directory-navigation.css?v=20260816-0001">
